...
public struct AttributeData(int fg, int bg, int extended) : IEquatable<AttributeData>
{
    /// <summary>
    ///     Bit layout:
    ...
    public static AttributeData Default => new()
    {
    ...
    public AttributeData() : this(256, 257, 0)
    {
    }
    ...
    /// </summary>
    public AttributeData(AttributeData other) : this(other.Fg, other.Bg, other.Extended)
    {
    }

    public bool IsBold()
    {
        return (Extended & BOLD) != 0;
    }

    public bool IsDim()
    {
        return (Extended & DIM) != 0;
    }

    public bool IsItalic()
    {
        return (Extended & ITALIC) != 0;
    }

    public bool IsUnderline()
    {
        return (Extended & UNDERLINE) != 0;
    }

    public bool IsBlink()
    {
        return (Extended & BLINK) != 0;
    }

    public bool IsInverse()
    {
        return (Extended & INVERSE) != 0;
    }

    public bool IsInvisible()
    {
        return (Extended & INVISIBLE) != 0;
    }

    public bool IsStrikethrough()
    {
        return (Extended & STRIKETHROUGH) != 0;
    }

    public bool IsOverline()
    {
        return (Extended & OVERLINE) != 0;
    }
    ...
    {
        SetFlag(INVERSE, value);
    }

    public void SetInvisible(bool value)
    {
        SetFlag(INVISIBLE, value);
    }
    ...
    public void SetOverline(bool value)
    {
        SetFlag(OVERLINE, value);
    }
